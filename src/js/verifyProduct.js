    ...
    getData:function(event) {
        ...
        web3.eth.getAccounts(function(error,accounts){
            ...
            App.contracts.product.deployed().then(function(instance){
                ...
                console.log(productSN, 'prod')
                console.log(consumerCode, 'cccc')
                const p = web3.fromAscii(productSN)
                console.log(p, 'pppp')
                console.log(web3.fromAscii(consumerCode), 'ooooo')
                return productInstance.verifyProduct.call(web3.fromAscii(productSN),web3.fromAscii(consumerCode),{from:account});
